...
export default function MidOrderDetails() {
  const steps = [
        ...
        <Card className="md:col-span-5 flex flex-col justify-between">
          ...
          <CardContent className="space-y-12">
            ...
            <div className="flex gap-4 pt-4">
              <Button variant="outline" className="flex-1 rounded-full border-slate-200 text-slate-600">
                Cancle
              </Button>
            ...
            <CardContent className="flex items-center gap-5">
              ...
              <div className="space-y-1">
                ...
                <div className="flex flex-col gap-1 pt-1">
                  ...
                  <span className="flex items-center gap-2 text-md text-slate-600">
                    <Mail className="w-4 h-4 text-slate-400" /> doe.john@gmail.com
                  </span>
                </div>
              </div>
            </CardContent>
        ...
        <CardContent className="p-0">
          <div className="overflow-x-auto">
            ...
            <Avatar className="h-12 w-14 border-2 border-slate-100">
                        ...
                        <p className="font-bold text-slate-900">Nike Air Jordon</p>
                        <p className="text-xs text-slate-400">SKU-FRT-234</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-5 text-center">
                    <Badge variant="secondary" className="bg-emerald-50 text-emerald-600 hover:bg-emerald-50 border-none px-3 py-1">
                      Delivered <ChevronDown className="ml-1 w-4 h-4" />
                    </Badge>
                  </td>
                  <td className="px-6 py-5 text-center text-slate-600">1x</td>
                  <td className="px-6 py-5 text-right font-bold text-slate-900">$299</td>
                </tr>
              </tbody>
            </table>
          </div>
