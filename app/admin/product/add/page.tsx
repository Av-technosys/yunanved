  ...
  return (
    <div className="max-w-7xl mx-auto p-4 space-y-6">
      <form onSubmit={handleCreateProduct}>
        <div className="flex flex-col items-start gap-3 justify-start sm:flex-row  sm:justify-between sm:items-center sm:gap-0 bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60 sticky top-0 z-10 py-4 border-b">
          <div>
