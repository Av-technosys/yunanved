...
export const AWS_SECRET_ACCESS_KEY: string = process.env.AWS_SECRET__ACCESS_KEY!;
...
export const SHIPROCKET_EMAIL: string = process.env.SHIPROCKET_EMAIL!;
export const SHIPROCKET_PASSWORD: string = process.env.SHIPROCKET_PASSWORD!;    
